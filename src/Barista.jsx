...
import "../src/styles/Barista.css"
const Barista = () => {
  return (
    <>
    <div className="p-5 bg-[#edebe9] w-100 mt-14 lg:pl-20 lg:pr-20 pb-10 relative">
        <div className="pl-5 flex justify-between">
            <span className="text-2xl font-bold font-sans text-[#1e3932]">Barista Recommends</span>
             <span className="text-[#00854a] font-semibold text-sm curson-pointer ">View menu</span>
        </div>
    ...
    >
      <SwiperSlide><div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer">
        <div className="grid grid-cols-[1fr_3fr]">
            <div>
              <img src="https://www.starbucks.in/assets/icon/placeholder.webp" alt="" 
              className="rounded-lg h-20 object-cover" width={80}/>
            </div>
            <div className="p-2">
        ...
        <div className="mt-5 flex justify-between items-center">
          <div>
            <span className="font-semibold text-sm">₹ 283<span className="text-xs">.50</span></span>
          </div>
          <div>
            <button className="border-2 p-2 rounded-3xl text-white text-xs bg-[#00754a] hover:bg-lime-950">Add Item</button>
          </div>
        </div>
        </div></SwiperSlide>
      ...
      <SwiperSlide><div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer">
        <div className="grid grid-cols-[1fr_3fr]">
            <div>
              <img src="https://starbucksstatic.cognizantorderserv.com/Items/Small/webP/100447.webp" alt="" 
              className="rounded-lg h-20 object-cover" width={80}/>
            </div>
            <div className="p-2">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-xs text-[#6c757d]">SHORT(237mL).284kcal</p>
            </div>
        </div>
        <div className="mt-5 flex justify-between items-center">
          <div>
            <span className="font-semibold text-sm">₹ 309<span className="text-xs">.75</span></span>
          </div>
          <div>
            <button className="border-2 p-2 rounded-3xl text-white text-xs bg-[#00754a] hover:bg-lime-950">Add Item</button>
          </div>
      ...
      <SwiperSlide><div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer">
        <div className="grid grid-cols-[1fr_3fr]">
            <div>
              <img src="https://starbucksstatic.cognizantorderserv.com/Items/Small/webP/112573.webp" alt="" 
              className="rounded-lg h-20 object-cover" width={80}/>
            </div>
            <div className="p-2">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-xs text-[#6c757d]">TALL(354 mL).PER SERVE(354mL)-531kcla</p>
            </div>
        </div>
        <div className="mt-5 flex justify-between items-center">
          <div>
            <span className="font-semibold text-sm">₹ 387<span className="text-xs">.00</span></span>
          </div>
          <div>
            <button className="border-2 p-2 rounded-3xl text-white text-xs bg-[#00754a] hover:bg-lime-950">Add Item</button>
          </div>
      ...
      <SwiperSlide><div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer">
        <div className="grid grid-cols-[1fr_3fr]">
            <div>
              <img src="https://starbucksstatic.cognizantorderserv.com/Items/Small/webP/104997.webp" alt="" 
              className="rounded-lg h-20 object-cover" width={80}/>
            </div>
            <div className="p-2">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="font-semibold">Cold Brew Coffee</p>
            <p className="text-xs text-[#6c757d]">SHORT(Short cold brew black)</p>
            </div>
        </div>
        <div className="mt-5 flex justify-between items-center">
          <div>
            <span className="font-semibold text-sm">₹ 299<span className="text-xs">.25</span></span>
          </div>
          <div>
            <button className="border-2 p-2 rounded-3xl text-white text-xs bg-[#00754a] hover:bg-lime-950">Add Item</button>
          </div>
        ...
        <div className="grid grid-cols-[1fr_3fr]">
            ...
            <p className="font-semibold">Tall Java Chip Frappuccino </p>
            <p className="text-xs text-[#6c757d]">TALL()</p>
            </div>
        </div>
        <div className="mt-5 flex justify-between items-center">
          <div>
            <span className="font-semibold text-sm">₹ 388<span className="text-xs">.</span></span>
          </div>
          <div>
            <button className="border-2 p-2 rounded-3xl text-white text-xs bg-[#00754a] hover:bg-lime-950">Add Item</button>
          </div>
